      ...
      <div className="details flex-grow-0 ">
        <form action="">
          <div className="form-floating mb-3">
            <input type="text" value={appContext.fullname ?? ''} className="form-control" id="fullName" ref={fullNameR} />
            <label htmlFor="fullName">Full Name</label>
          </div>
          <div className="form-floating mb-3">
            <input type="email" value={appContext.email ?? ''} className="form-control" id="email" ref={emailR} />
            <label htmlFor="email">Email address</label>
          </div>
          <div className="form-floating">
            <input type="text" value={appContext.username ?? ''} className="form-control" id="username" ref={usernameR}  />
